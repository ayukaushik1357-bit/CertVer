...
function ForgotPasswordForm(_a) {
    ...
    var _o = react_1.useState({
        x: 0,
        y: 0
    }), otpMousePosition = _o[0], setOtpMousePosition = _o[1];
    var _p = react_1.useState(false), isOtpHovering = _p[0], setIsOtpHovering = _p[1];
    var otpRef = react_1.useRef(null);
    ...
    react_1.useEffect(function () {
        ...
        var handlers = {
            ...
            otp: {
                mousemove: function (e) {
                    return handleMouseMove(e, setOtpMousePosition, otpRef);
                },
                mouseenter: function () { return setIsOtpHovering(true); },
                mouseleave: function () { return setIsOtpHovering(false); }
            }
        };
    ...
    var handleSubmit = react_1.useCallback(function (e) { return __awaiter(_this, void 0, void 0, function () {
        var formData, validationErrors, firstErrorField, email, otp, newPassword, res, data, error_1;
        var _a, _b, _c;
            ...
            switch (_d.label) {
                case 0:
                    ...
                    if (validationErrors.length > 0) {
                        ...
                        if (firstErrorField === "otp" && ((_a = otpRef.current) === null || _a === void 0 ? void 0 : _a.querySelector("input"))) {
                            otpRef.current.querySelector("input").focus();
                        }
                        else if (firstErrorField === "newPassword" && ((_b = newPasswordRef.current) === null || _b === void 0 ? void 0 : _b.querySelector("input"))) {
                            newPasswordRef.current.querySelector("input").focus();
                        }
                        else if (firstErrorField === "confirmPassword" && ((_c = confirmPasswordRef.current) === null || _c === void 0 ? void 0 : _c.querySelector("input"))) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("/api/auth/sign-in/changeForgotPassword", {
                            method: "POST",
                ...
                React.createElement("form", { onSubmit: handleSubmit, className: "relative z-10", noValidate: true },
                    React.createElement("fieldset", { disabled: isLoading, className: "flex flex-col gap-8 disabled:opacity-75 disabled:pointer-events-none" },
                        ...
                        React.createElement("div", { className: "grid gap-4 animate-stagger-2" },
                            React.createElement(label_1.Label, { htmlFor: "otp", className: "text-white text-sm font-medium smooth-transition" }, "Enter the OTP received"),
                            React.createElement("div", { ref: otpRef, className: "relative" },
                                React.createElement(input_1.Input, { id: "otp", name: "otp", type: "text", inputMode: "numeric", pattern: "\\d*", autoComplete: "one-time-code", required: true, "aria-describedby": "otp-description", className: "bg-transparent border border-white/20 focus:border-white/40 smooth-transition rounded-lg text-white placeholder:text-white/50 pr-12 h-12 px-4 no-outline" }),
                                isOtpHovering && (React.createElement("div", { className: "absolute inset-0 rounded-lg pointer-events-none smooth-transition", style: getGlassStyle(otpMousePosition, isOtpHovering), "aria-hidden": "true" }))),
                            React.createElement("div", { id: "otp-description", className: "sr-only" }, "Enter the one-time password sent to your email.")),
                        React.createElement("div", { className: "grid gap-4 animate-stagger-2" },
